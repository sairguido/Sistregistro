...
class GestorSlide{
    ...
    static public function mostrarImagenController($datos){
        ...
        #list() = Al igual que array(), no es realmente una funcion, es un contructor del lenguaje. 
        #list() = se utiliza para asignar una lista variables en una sola operación
        ...
        if($ancho < 1600 || $alto < 600){
            ...
            #imagecrop() - Recorta una imagen usando las coordenadas, el tamaño x,y, ancho y alto datos

            $destino = imagecrop($origen, ["x"=>0,"y"=>0, "whidth"=>1600, "heigth"=>600]);
    ...
    static public function editorSlideController(){
        ...
        foreach ($respuesta as $row => $item) {
           echo '<li id="item'.$item["id"].'">
                  ...
                  <img src="'.substr($item["ruta"],6).'" style="float:left; margin-bottom:10px" whidth="80%">
                  <h1>'.$item["titulo"].'</h1>
